                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="akameNav">
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    </span> <a href="index.php"><input type="image" src="./img/core-img/home.png"class="home"/></a>
                                    <!--<li class="active"><a href="./index.html">Home</a></li>-->
                                    <li><a href="products.php">Produits</a>
                                        <ul class="dropdown">
                                    ...
                                    <li><a href="Panier.php"><input type="image" src="./img/core-img/cartee.png"class="carte"/></a></li>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text">
                                    <h2 data-animation="fadeInUp" data-delay="100ms">bienvenue <br> </h2>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-6">
                                <div class="welcome-text">
                                    ...
                                    <p data-animation="fadeInUp" data-delay="400ms">“Créez votre meuble en quelque clics, nous vous le livrons chez vous en kit.Livraison gratuite partout en tunisie.”</p>
